...
import { CalendarClock, AlertOctagon, ArrowUpRight } from 'lucide-react';
      ...
      <div>
        <div className="flex items-center justify-between mb-3.5 pb-2.5 border-b border-slate-800">
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-sm font-bold text-slate-100">Scheduled Bills & Upcoming Payables</h3>
          </div>
                ...
                >
                  <div>
                    <div className="flex items-center gap-2 mb-0.5">
                      <span className="font-bold text-xs text-slate-200">{ob.category}</span>
                    ...
                    <span className="text-[11px] text-slate-400 font-mono">Date: {ob.due_date}</span>
                  </div>
